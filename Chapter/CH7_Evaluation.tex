...
ROC Curve แสดงว่าตัวแบบมี
ประสิทธิภาพดี โดยมี AUC = 0.875
ซึ่งสูงกว่าเส้นทแยงมุม (0.5)
อย่างมีนัยสำคัญ
\end{minipage}
...
Lasso alpha=0.01: RMSE=4.0892, n_features=9
Lasso alpha=0.1: RMSE=4.2345, n_features=7
Lasso alpha=1: RMSE=4.6789, n_features=5
Lasso alpha=10: RMSE=5.4321, n_features=2
Lasso alpha=100: RMSE=6.1234, n_features=0
