...
\begin{exmp}
\label{exmp:train_test_split}
พิจารณาข้อมูลผู้สมัครงาน 1000 คนเพื่อสร้างตัวแบบทำนายว่าผู้สมัครจะได้รับการคัดเลือกหรือไม่ เมื่อใช้ Train-Test Split ด้วยสัดส่วน 80:20 โดยสุ่มแบ่งข้อมูล 800 คนสำหรับฝึกสอนและ 200 คนสำหรับทดสอบ

สมมติผลการทดสอบบนชุดทดสอบแสดงดังนี้: Accuracy = 0.85, Precision = 0.78, Recall = 0.72

ผลการประเมินบนชุดทดสอบบ่งบอกว่าตัวแบบสามารถทำนายได้ถูกต้องร้อยละ 85 เมื่อเทียบกับค่าจริง ค่า Precision = 0.78 หมายความว่าเมื่อตัวแบบทำนายว่าผู้สมัครจะได้รับการคัดเลือก จะถูกต้องประมาณร้อยละ 78 และค่า Recall = 0.72 หมายความว่าตัวแบบสามารถตรวจพบผู้ที่ได้รับการคัดเลือกได้ประมาณร้อยละ 72

หากต้องการผลการประเมินที่น่าเชื่อถือมากขึ้น ควรทำ Cross-Validation เพื่อให้แน่ใจว่าผลการประเมินไม่ขึ้นกับการสุ่มแบ่งข้อมูลเพียงครั้งเดียว
\end{exmp}
